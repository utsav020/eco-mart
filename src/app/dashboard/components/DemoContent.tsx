    ...
    <div className="w-full min-h-screen bg-gray-50">
      <div className="p-4 md:p-6 lg:p-8">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="">
            <select className="border border-gray-300 rounded-md px-3 py-2 rext-md text-[#374151] focus:outline-none focus:ring-2 focus:ring-[#4F46E5]">
              <option>Week</option>
              <option>Month</option>
              <option>Year</option>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-5">
          ...
          <div className="bg-indigo-50 border border-indigo-200 rounded-xl p-5">
            <div className="flex items-center gap-3">
              ...
              <p className="text-md text-[#4F46E5]">Total Orders</p>
            </div>
            <h1 className="text-2xl py-5 font-bold text-[#4F46E5] mt-2">
          ...
          <div className="bg-green-50 border border-green-200 rounded-xl p-5">
            <div className="flex items-center gap-3">
              ...
              <p className="rext-md text-[#16A34A]">Delivered Revenue</p>
            </div>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-5">
            <div className="flex items-center gap-3">
              <Clock className="w-6 h-6 text-[#CA8A04]" />
              <p className="rext-md text-[#CA8A04]">Pending Orders</p>
            </div>
            <h1 className="text-2xl py-5 font-bold text-[#CA8A04] mt-2">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-5">
            <div className="flex items-center gap-3">
              <Truck className="w-7 h-7 text-[#3B82F6]" />
            <p className="rext-md text-[#3B82F6]">Shipped Orders</p>
            </div>
            <h1 className="text-2xl py-5 font-bold text-[#3B82F6] mt-2">
          ...
          <div className="bg-red-50 border border-red-200 rounded-xl p-5">
            ...
            <p className="rext-md text-[#DC2626]">Cancelled Orders</p>
             </div>
        ...
        {/* FOOTER */}
        <div className="mt-10 py-5 border-t border-gray-200 flex flex-col sm:flex-row items-center justify-between rext-md text-[#4B5563]">
