        ...
        <SwiperSlide>
          ...
          >
            <div className="px-6 md:px-16 lg:px-28 max-w-[900px]">
              ...
              {/* PAGINATION */}
              <div className="absolute bottom-17 md:bottom-30 left-50 md:left-1/2 transform -translate-x-1/2 w-[180px] md:w-[220px] flex justify-between">
                <div
                  className={`h-[5px] w-[45%] ${
        ...
        <SwiperSlide>
          ...
          >
            <div className="px-6 md:px-16 lg:px-28 max-w-[900px]">
              ...
              {/* PAGINATION */}
              <div className="absolute bottom-17 md:bottom-31 left-50 md:left-1/2 transform -translate-x-1/2 w-[180px] md:w-[220px] flex justify-between">
                <div
                  className={`h-[5px] w-[45%] ${
                    activeIndex === 0 ? "bg-[#A3C526]" : "bg-black/30"
                  }`}
